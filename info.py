...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002014173170'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6005627579').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# updates_channel means force subscribe channel.
...
updates_channel = environ.get('UPDATES_CHANNEL', '') # give your force subscribe channel id here else leave it blank
UPDATES_CHANNEL = int(updates_channel) if updates_channel and id_pattern.search(updates_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002014173170')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002280652416')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002350351783')).split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'IITLectures')

# Filter Keywords for Unwanted Files (e.g., "PreDVD")
filter_keywords = environ.get('FILTER_KEYWORDS', "Clean Aud,PreDVD,DVDScr").split(',')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'itzsrk98') # owner username without @
...
WELCOME_NEW_USERS = is_enabled((environ.get('WELCOME_NEW_USERS', "True")), True)
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '083dcba3f78a3f6f831f3545420c97037c4c51ae')
